...
class Kuwait extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        home: Scaffold(
            ...
            appBar: AppBar(title: Text('Kuwait', style: TextStyle(color: Colors.blueGrey, fontSize: 20, fontWeight: FontWeight.bold)),
...
class Kuwait1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
      ...
      child: Column(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              subtitle: Text("Number: 152", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
