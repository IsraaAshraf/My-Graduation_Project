...
class Somalia extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        home: Scaffold(
            ...
            appBar: AppBar(title: Text('Somalia', style: TextStyle(color: Colors.blueGrey, fontSize: 20, fontWeight: FontWeight.bold)),
...
class Somalia1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
      ...
      child: Column(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              subtitle: Text("Number: 888", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
            ...
            ListTile(
              ...
              subtitle: Text("Number: 999", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
            ...
            ListTile(
              ...
              subtitle: Text("Number: 555", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
            ...
            ListTile(
              ...
              subtitle: Text("Number: 777", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
