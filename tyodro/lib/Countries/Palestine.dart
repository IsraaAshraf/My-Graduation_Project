  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        home: Scaffold(
            ...
            appBar: AppBar(title: Text('Palestine', style: TextStyle(color: Colors.blueGrey, fontSize: 20, fontWeight: FontWeight.bold)),
...
class Palestine1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
      ...
      child: Column(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              subtitle: Text("Number: 100", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
            ...
            ListTile(
              ...
              subtitle: Text("Number: 101", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
            ...
            ListTile(
              ...
              subtitle: Text("Number: 102", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
