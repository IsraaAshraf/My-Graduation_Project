    ...
    return MaterialApp(
        home:
           ...
           Scaffold(
            ...
            appBar: AppBar(title: Text('Algeria', style: TextStyle(color: Colors.blueGrey, fontSize: 20, fontWeight: FontWeight.bold)),
...
class Algeria1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
      ...
      child: Column(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              subtitle: Text("Number: 1548", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
            ...
            ListTile(
              ...
              subtitle: Text("Number: 14", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
