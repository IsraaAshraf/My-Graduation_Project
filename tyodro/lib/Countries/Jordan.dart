  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        home: Scaffold(
            ...
            appBar: AppBar(title: Text('Jordan', style: TextStyle(color: Colors.blueGrey, fontSize: 20, fontWeight: FontWeight.bold)),
      ...
      child: Column(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              subtitle: Text("Number: 911", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
