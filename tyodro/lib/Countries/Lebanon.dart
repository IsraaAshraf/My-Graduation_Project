...
class Lebanon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        home: Scaffold(
            ...
            appBar: AppBar(title: Text('Lebanon', style: TextStyle(color: Colors.blueGrey, fontSize: 20, fontWeight: FontWeight.bold)),
...
class Lebanon1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
      ...
      child: Column(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              subtitle: Text("Number: 112, 160", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
            ...
            ListTile(
              ...
              subtitle: Text("Number: 140", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
            ...
            ListTile(
              ...
              subtitle: Text("Number: 175", style: TextStyle(fontSize: 15, color: Colors.pink, fontWeight: FontWeight.bold)),
            ),
